			...
			<div class="section-out">
				<section class="login-section">
                        ...
                        <form method="POST" action="/auth/login">
                            ...
                            <ul class="ul-list">
                                ...
                                <li><input type="password" name = "password" id = "password" required class="input" placeholder="Password"/><span class="icon"><i class="fa fa-lock"></i></span></li>
                              	...
                              	<li><span class="remember"><input type="checkbox" id="check"> <label for="check">Remember Me</label></span><span class="remember"><a href="{{ url('/pages/forget_pass') }}" data-toggle = "modal">Forget Password</a></span></li>
					...
					<div class="social-login">Or sign in with &nbsp;
                            ...
                            <a href="" class="gh"><i class="fa fa-github"></i></a>
